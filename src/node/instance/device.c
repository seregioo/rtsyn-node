...
static rtsyn_node_id_t device_id = 0;

rtsyn_node_t *
rtsyn_node_create_device(const char *module_path, uint32_t num_ports,
...
{
    rtsyn_node_t *node = rtsyn_node_create(module_path, RTSYN_ABI_NODE_DEVICE, device_id, num_ports,
